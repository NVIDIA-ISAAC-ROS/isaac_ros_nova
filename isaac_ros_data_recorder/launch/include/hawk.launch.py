...
def generate_launch_description():
    ...
    isaac_ros_hawk_launch_dir = os.path.join(
        get_package_share_directory('isaac_ros_hawk'), 'launch')

    hawk_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([isaac_ros_hawk_launch_dir, '/hawk.launch.py']),
        launch_arguments={
    ...
    return LaunchDescription(launch_args + [hawk_launch, load_nodes])
