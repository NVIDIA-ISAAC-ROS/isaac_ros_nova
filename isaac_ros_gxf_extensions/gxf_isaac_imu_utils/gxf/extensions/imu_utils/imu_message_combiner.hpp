...
class ImuMessageCombiner : public gxf::Codelet {
 ...
 private:
  ...
  gxf::Expected<void> syncImuDataInterpolate();
  ...
  AccelerometerMessageParts curr_accel_msg_parts_;
  AccelerometerMessageParts prev_accel_msg_parts_;
  GyroscopeMessageParts curr_gyro_msg_parts_;
  ...
  gxf::Parameter<std::string> combine_method_;
  gxf::Parameter<bool> apply_delay_offsets_;
  gxf::Parameter<int64_t> accelerometer_offset_ns_;
  gxf::Parameter<int64_t> gyroscope_offset_ns_;
};
