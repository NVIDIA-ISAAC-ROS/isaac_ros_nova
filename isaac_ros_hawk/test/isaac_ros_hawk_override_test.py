...
def generate_test_description():
    ...
    if (result.stdout.strip() == 'Device Found'):
        IsaacArgusHawkNodeCameraOverrideTest.skip_test = False
        ...
        correlated_timestamp_driver_node = ComposableNode(
            ...
            namespace=IsaacArgusHawkNodeCameraOverrideTest.generate_namespace(),
        ...
        argus_stereo_node = ComposableNode(
            ...
            parameters=[{'module_id': device_id,
                        'left_camera_info_url': 'file://' +
                         IsaacArgusHawkNodeCameraOverrideTest.left_override_filepath,
                         'right_camera_info_url': 'file://' +
                         IsaacArgusHawkNodeCameraOverrideTest.right_override_filepath
                         }]
        )

        return IsaacArgusHawkNodeCameraOverrideTest.generate_test_description([
            ComposableNodeContainer(
                name='argus_stereo_container',
                package='rclcpp_components',
                executable='component_container_mt',
                composable_node_descriptions=[argus_stereo_node, correlated_timestamp_driver_node],
                namespace=IsaacArgusHawkNodeCameraOverrideTest.generate_namespace(),
                output='screen',
        ...
        IsaacArgusHawkNodeCameraOverrideTest.skip_test = True
        return IsaacArgusHawkNodeCameraOverrideTest.generate_test_description(
            [launch_testing.actions.ReadyToTest()])


class IsaacArgusHawkNodeCameraOverrideTest(IsaacROSBaseTest):
    ...
    def test_image_camera_override(self):
        ...
        if self.skip_test:
            ...
            self.create_exact_time_sync_logging_subscribers(
                ...
                received_camera_messages, accept_multiple_messages=True)
            ...
            tf_message = self.query_transform(
                'hawk_right_optical', 'hawk_left_optical')
